<?php
/**
 * Strings for component 'block_newresources', language 'en'
 *
...
$string['pluginname'] = 'Bloco Novos Recursos';
$string['newresources'] = 'Novos Recursos';
...
$string['dateadded'] = 'Data de Publicação';